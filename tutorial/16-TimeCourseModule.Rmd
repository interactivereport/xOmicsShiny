...
This tab allow user to view the fitting plots for multiple genes in a single page. By default the "Plot" tab shows the plot for the first 9 genes in alphabetical order if not filter applied to the data. The "Table" tab shows the result data in the table format for the genes shown in the Plot tab. 
