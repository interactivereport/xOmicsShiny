...
This module enable users to combine different datasets together if they have multiple datasets of the same or similar study and want to check them together. The functions that support a single dataset can be used by the merged data. 
