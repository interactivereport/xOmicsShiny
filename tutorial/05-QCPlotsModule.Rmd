...
Furthermore, the plot can be saved in high resolution by clicking on "Save to Output”. Section <span style="font-size:2em; color:red"> *insert section number* </span> of this document describes the next steps of downloading and obtaining the saved plots.
...
<span style="font-size:2em; color:red"> *The demo datasets does not contain the information for this plot* </span>
...
Using the Mouse microglia RNA-Seq dataset, which was demoed in the QuickOmics tutorial,it showed clearly samples of the same Age have the smaller distances, that is, they have closer gene expression patterns. Here again, Users have the option to save to output.
