...
<span style="font-size:2em; color:red"> *The table needs update to complete the reference information and proper layout* </span>
...
<span style="font-size:2em; color:red"> *insert a successfully uploaded data set ScreenShot when update is completed* </span>
...
<span style="font-size:2em; color:red"> *insert a ScreenShot when update is completed* </span>
