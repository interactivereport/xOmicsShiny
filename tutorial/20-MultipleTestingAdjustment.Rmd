...
Gene co-expression or protein-protein interaction networks are constructed by computing pairwise correlations (e.g., Pearson, Spearman) across genes. The visNetowrk and netowrkD3 visulization tools in the correlation network module display the pairwise correlation result direction without any multiple testing adjustment.